...
public class ModelPingerApp {
    public static void main(String[] args) {
        ...
        startPingInterval(producer, modelPingTopic, pingInterval);
    ...
    private static void sendModelPing(Producer<String, String> producer, String topic) {
        try {
